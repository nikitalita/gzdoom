...
DummyNode::DummyNode(std::string name, std::string value, std::string type)
        : m_name(std::move(name)), m_value(std::move(value)), m_type(std::move(type)) {
}
...
DummyWithChildrenNode::DummyWithChildrenNode(std::string name, std::string value, std::string type,
